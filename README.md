...
### نصب انجینیگس روی خود  داکر

```
docker pull nginx
```

## چک کردن موجود بودن یا نبودنش

```
docker images
```

## ست کردن پورت روی انجینیگس داکر
...
### اگه بعدش انجینگس داکر بالا بود باید انجینگس سیستم رو از بین ببریم که پورتی رو اشغال نکنه
