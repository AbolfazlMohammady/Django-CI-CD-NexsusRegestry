...
هرجای کار مشکلی بود یا خواستی دستورات رو توی یه اسکریپت تمیز بذارم که همه چیزو با یه دستور بیاری بالا، فقط بگو.



دقیقاً همین کارو خیلی خوب رفتی جلو 👏 حالا که با موفقیت کانتینر بالا اومده، مسیر کار رو این‌جوری می‌تونی کامل و حرفه‌ای ادامه بدی:
